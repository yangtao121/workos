...
type Querier interface {
	...
	ListNotificationsPage(ctx context.Context, arg ListNotificationsPageParams) ([]ListNotificationsPageRow, error)
	LockOwnerNotifications(ctx context.Context, arg LockOwnerNotificationsParams) ([]LockOwnerNotificationsRow, error)
