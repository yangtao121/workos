...
RUN install -d -m 0755 -o 10001 -g 10001 \
    /run/workos /run/workos/tls /run/workos/execution \
    /run/workos/core-execution /run/workos/harness-execution /run/workos/vault \
    /var/lib/workos/harness-sessions
USER 10001:10001
WORKDIR /tmp
